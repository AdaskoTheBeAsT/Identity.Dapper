...
namespace Identity.Dapper.Tests.ConnectionProviders
{
    public class MySqlConnectionProviderTest
    {
        ...
        {
            const string connectionString = "Server=myServerAddress;Database=myDataBase;User Id=xxxx;Password=xxxx";
            ...
            const string expected = "Server=myServerAddress;Database=myDataBase;User Id=testUsername;Password=testPassword";
